...
public extension MCamera {
     ...
     */
    func setCameraOutputType(_ cameraOutputType: CameraOutputType) -> Self { config.initialOutputType = cameraOutputType; return self }
     ...
     */
    func setCameraPosition(_ cameraPosition: CameraPosition) -> Self { config.initialCameraPosition = cameraPosition; return self }
     ...
     */
    func setAudioAvailability(_ isAvailable: Bool) -> Self { config.initialIsAudioAvailable = isAvailable; return self }
     ...
     */
    func setZoomFactor(_ zoomFactor: CGFloat) -> Self { config.initialZoomFactor = zoomFactor; return self }
     ...
     */
    func setFlashMode(_ flashMode: CameraFlashMode) -> Self { config.initialFlashMode = flashMode; return self }
     ...
     */
    func setLightMode(_ lightMode: CameraLightMode) -> Self { config.initialLightMode = lightMode; return self }
     ...
     */
    func setResolution(_ resolution: AVCaptureSession.Preset) -> Self { config.initialResolution = resolution; return self }
     ...
     */
    func setFrameRate(_ frameRate: Int32) -> Self { config.initialFrameRate = frameRate; return self }
     ...
     */
    func setCameraExposureDuration(_ duration: CMTime) -> Self { config.initialExposureDuration = duration; return self }
     ...
     */
    func setCameraTargetBias(_ targetBias: Float) -> Self { config.initialTargetBias = targetBias; return self }
     ...
     */
    func setCameraISO(_ iso: Float) -> Self { config.initialISO = iso; return self }
     ...
     */
    func setCameraExposureMode(_ exposureMode: AVCaptureDevice.ExposureMode) -> Self { config.initialExposureMode = exposureMode; return self }
     ...
     */
    func setCameraHDRMode(_ hdrMode: CameraHDRMode) -> Self { config.initialHDRMode = hdrMode; return self }
     ...
     */
    func setCameraFilters(_ filters: [CIFilter]) -> Self { config.initialFilters = filters; return self }

    /**
     Changes the initial mirror output setting.
     */
    func setMirrorOutput(_ shouldMirror: Bool) -> Self { config.initialMirrorOutput = shouldMirror; return self }

    /**
     Changes the initial grid visibility setting.
     */
    func setGridVisibility(_ shouldShowGrid: Bool) -> Self { config.initialGridVisibility = shouldShowGrid; return self }

    /**
     Changes the shape of the focus indicator visible when touching anywhere on the camera screen.
     */
    func setFocusImage(_ image: UIImage) -> Self { config.focusImage = image; return self }

    /**
     Changes the color of the focus indicator visible when touching anywhere on the camera screen.
     */
    func setFocusImageColor(_ color: UIColor) -> Self { config.focusImageColor = color; return self }

    /**
     Changes the size of the focus indicator visible when touching anywhere on the camera.
     */
    func setFocusImageSize(_ size: CGFloat) -> Self { config.focusImageSize = size; return self }
}
...
public extension MCamera {
    /**
     ...
     ```
     */
    func lockCameraInPortraitOrientation(_ appDelegate: MApplicationDelegate.Type) -> Self { config.appDelegate = appDelegate; config.shouldLockOrientationInPortrait = true; return self }
